...
Chongyun and Kaeya enable Bennett to melt his elemental skill every 2 seconds for enormous damage. Bennett also enables Chongyun to melt his burst. Xingqiu adds freeze to keep the enemy in place. Kaeya and Xingqiu are both flexible and can be replaced. Note that you can’t add another pyro, Fischl, or Beidou to the team, as they would react with the cryo and prevent Bennett from melting.
